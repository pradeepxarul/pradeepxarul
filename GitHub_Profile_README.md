# 🚀 Pradeep Arul - AI/ML Developer & Full-Stack Engineer
...
- 🔬 **Specialization**: Retrieval-Augmented Generation (RAG), Vector Databases, LLM Integration
- 🏢 **Currently**: Software Developer Intern (AI/Automation) @ **Tringapps, Inc**
- 🎓 **Education**: B.Tech in Information Technology @ KCG College of Technology (Nov 2022 - May 2026)
- 📍 **Location**: Chennai, Tamil Nadu, India
- 💼 **Focus**: AI Agents, Enterprise Systems, AI/ML, Full-Stack Development, Cloud Infrastructure
...
### 🚀 Developer Intern (AI/Automation)
**Tringapps, Inc** | Oct 2025 – Present | Onsite
...
### ☁️ Cloud Infrastructure Intern (AWS)
...
### 📊 Data Analyst Intern
**INTERAIN** | Sep 2024 – Oct 2024 | Remote
...
<details open>
<summary><b>📌 RAG-Based Q&A System (AI-Powered Document Intelligence)</b></summary>

**Tech Stack**: React | Flask | Python | Gemini AI API | FAISS | MongoDB

- 🔧 Built intelligent document processing system using Retrieval-Augmented Generation
- 📄 Implemented PDF parsing and semantic retrieval for context-aware Q&A
- 🚀 Full-stack application with React frontend and Flask backend
- ⚡ Real-time Q&A with 95%+ accuracy on domain-specific documents
- 🔗 **[View Repository](https://github.com/pradeepxarul/rag-qa-system)**

</details>

<details>
<summary><b>🔗 LINKLOOM App (Task & Collaboration Platform)</b></summary>

**Tech Stack**: React Native | MongoDB | Node.js

- 👥 Created app for entrepreneurs to organize tasks and streamline collaboration
- 📱 Integrated business management and scheduling tools in unified platform
- 🎯 Full-featured task management with real-time sync
- 🔗 **[View Repository](https://github.com/pradeepxarul/linkloom)**

</details>

<details>
<summary><b>🧘 ZEN Self-Care App (Wellness & Habit Tracking)</b></summary>

**Tech Stack**: React Native | Firebase | Node.js

- 🎯 Developed self-care app with mental wellness and habit tracking modules
- 📊 Designed personalized goal-setting features to enhance user engagement
- ✨ Gamified progress tracking and achievements system
- 🔗 **[View Repository](https://github.com/pradeepxarul/zen-app)**
...
- 🎖️ **SPOT Event Head**: Led IT department for 12+ events | 1st place for highest registration
- 🏅 **Google Cloud** - Introduction to Generative AI
- 🏅 **IBM** - Project Management Fundamentals  
- 🏅 **Infosys Springboard** - Python & Java Fundamentals
...
├── Vector Databases (FAISS, Qdrant, MongoDB Vector Search)
...
- 📝 IEEE-publishable research in AI/ML
